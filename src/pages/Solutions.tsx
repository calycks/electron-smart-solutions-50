...
const Solutions = () => {
  ...
  const solutions = [{
    ...
    features: ["High-definition video recording", "Remote viewing over Internet", "Network camera connectivity", "Real-time monitoring & control", "Event documentation system", "24/7 surveillance capability"]
  }, {
    icon: Lock,
    ...
    features: ["Remote lock control via Internet", "Smartphone app integration", "User access management", "Access logs & tracking", "Flexible permission settings", "Electronic security components"]
  }, {
    icon: Tv,
    title: "IPTV",
    ...
    image: iptv,
    features: ["Live TV channels streaming", "Video on Demand (VOD)", "Multi-device compatibility", "High-speed Internet delivery", "Sports & entertainment content", "Flexible viewing experience"]
  }, {
    icon: Volume2,
    ...
    image: paAudio,
    features: ["Large area audio coverage", "Public announcements capability", "Remote system control", "Multi-zone audio management", "Emergency alert integration", "Clear sound transmission"]
  }, {
    icon: Phone,
    title: "Voice Over IP",
    ...
    image: voip,
    features: ["Internet-based voice calls", "Digital data transmission", "Video calling capability", "Global communication access", "Cost-effective solutions", "Unified communications platform"]
  }, {
    icon: Radio,
    title: "GRMS",
    ...
    image: paAudio,
    features: ["Wireless communication networks", "Building-wide coverage", "Cordless phone integration", "Instant communication capability", "Work team coordination", "Mobile communication solution"]
  }, {
    icon: Building2,
    title: "BMS",
    ...
    image: bms,
    features: ["Integrated building control", "HVAC system management", "Lighting control systems", "Security system integration", "Energy efficiency optimization", "Central monitoring platform"]
  }];
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-20">
            ...
            return <div key={solution.title} className={`grid lg:grid-cols-2 gap-12 items-center ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
                  {/* Content */}
                  <div className={`${!isEven ? 'lg:order-2' : ''} fade-in-up ${isVisible ? 'animate' : ''}`}>
                    ...
                    <div className="space-y-3 mb-8">
                      {solution.features.map((feature, idx) => <div key={idx} className="flex items-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            description: "Control and monitor systems from anywhere"
          }, {
          ...
          }].map((item, index) => <div key={item.title} className={`text-center fade-in-up ${isVisible ? 'animate' : ''}`} style={{
